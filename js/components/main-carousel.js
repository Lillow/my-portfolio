...
generation.addEventListener("mouseover", function changeText() {
  text1.innerHTML =
    "Em 2021 participou do bootcamp <span class= 'emphasis -generation'>Desenvolvedor Web Java Junior</span> na instituição <span class= 'emphasis -generation'>Generation Brasil</span> e lá aprendeu práticas sobre: Metodologia Ágil - <span class= 'emphasis -generation'>SCRUM</span>, Lógica de Programação e Paradigma de Programação Orientada a Objetos em <span class= 'emphasis -generation'>Java</span>, versionamento (<span class= 'emphasis -generation'>Git</span>/<span class= 'emphasis -generation'>GitHub</span>), Banco de dados com <span class= 'emphasis -generation'>Mysql</span>, API Rest com <span class= 'emphasis -generation'>Spring Boot</span>, fundamentos web (<span class= 'emphasis -generation'>HTML5</span>, <span class= 'emphasis -generation'>CSS3</span>, <span class= 'emphasis -generation'>JavaScript</span> e <span class= 'emphasis -generation'>Bootstrap</span>), Experiência do Usuário - <span class= 'emphasis -generation'>UX</span>, componentização em <span class= 'emphasis -generation'>Angular</span>. Também aperfeiçoou e aprendeu algumas habilidades e mentalidades como: Orientação ao Futuro, Responsabilidade Pessoal, Mentalidade de Crescimento, Persistência, Trabalho em Equipe, Atenção aos Detalhes, Proatividade e Comunicação. Lá pôde descobrir o quão fascinante e estimulante é o mundo da <span class= 'emphasis -generation'>Programação</span>.";
});
